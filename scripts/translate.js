...
const i18n = {
  ...
  translations: {
    ...
    ru: {
      ...
      "review-text-5": "❝ Спасибо, Лео! Объяснения кристально ясные. На середине курса запустил первый AI-проект — уже есть результат. Ты — в топе моих преподавателей. ❞",
      "review-name-5": "Элиф С., 29",
      "review-role-5": "Motion-дизайнер",
      "review-text-6": "❝ Хотел ленту салона, но боялся качества фото. ИИ сделал портрет-маскота как живого — с ним фоткаются чаще, чем с зеркалом! ❞",
      "review-name-6": "Мурат К., 31",
      "review-role-6": "Владелец барбершопа",
      "review-text-7": "❝ Думал, буду самым возрастным, но курс — по шагам. К третьему уроку — снимок студийного уровня с ультра-деталями кожи. Отличный опыт, Лео! ❞",
      "review-name-7": "Pav Williams L., 50",
      "review-role-7": "Предприниматель",
      "review-text-8": "❝ Скептически тестил — думал, свет не заменить. ИИ не заменил — помог. Делаю skin-референсы, показываю парам — картинка понятна мгновенно. Съёмки быстрее, эмоций больше. ❞",
      ...
      "about-desc-p1": "Бывший исследователь Dubai Future Labs, ныне контент-стратег. Вместе с женой создал AI Influencer 3.0 — систему, которая помогла 2,130+ авторам запускать AI-бренды и утраивать охваты без студийных бюджетов.",
      "about-desc-p2": "Лео превращает идеи в доход: Midjourney, Omnisphere и face-lock-пайплайны снижают затраты и ускоряют вывод контента в 3 раза.",
      ...
      "faq-desc": "Стройте парасоциальные связи — пусть фанаты чувствуют настоящую вовлечённость.",
      "faq-q1": "Макс: Сколько ждать первых результатов?",
      "faq-a1": "Первые фотореальные кадры — уже в первый вечер; полноценная лента — за 4–7 дней при 1–2 ч в день.",
      "faq-q2": "Изабель: Совмещается с работой или учёбой?",
      "faq-a2": "Да. Уроки до 20 минут и доступны 24/7 — смотрите вечером или на выходных.",
      "faq-q3": "Аника: Сколько времени уделять проекту?",
      "faq-a3": "1–2 часа в день достаточно, чтобы запустить контент и масштабироваться.",
      "faq-q4": "Хассан: Какие инструменты покупать?",
      "faq-a4": "Только Midjourney — Basic $10/мес для старта или Standard $30/мес быстрее. Остальное — дешёвая поминутная оплата, копейки против одного профи-съёма.",
      "faq-q5": "Сара: Как держать постоянство кадров?",
      "faq-a5": "Внутри — Face-Lock Consistency System: готовые промпты и настройки, фиксирующие черты лица, чтобы каждый кадр был «из одной съёмки».",
      "faq-q6": "Софи: Поймут ли, что модель — ИИ? Нужна ли моя внешность?",
      "faq-a6": "Наш пайплайн делает кадры «как фото». Показывать своё лицо не обязательно — используйте вымышленного персонажа или «прокачанную» версию себя.",
      "faq-q7": "Алекс: Можно для личных/частных проектов?",
      "faq-a7": "Да. Обученная модель — ваша. Используйте в блогах, рекламе и закрытом контенте без ограничений.",
      "faq-q8": "Белла: Чем этот курс отличается? Учиться в своём темпе?",
      "faq-a8": "2,5 часа выжимки, шаблоны, чек-листы и поддержка. Учитесь в своём темпе; пожизненный доступ и обновления.",

      // Final CTA
      "final-cta-title": "AI-модели станут <span class=\"gradient-text\">рынком $2.5B</span> к 2030",
      "final-cta-subtitle": "Хайп вокруг AI-инфлюенсеров — как золотая лихорадка Bitcoin 2012 и бум NFT 2021.",
      "final-cta-save": "Сэкономьте $93 сегодня!",
      "final-cta-btn-text": "Забрать курс за",
      "course-sales-label": "покупок курса сегодня",
      "footer-title": "AI Influencer 3.0",
      "footer-desc": "Включайтесь в AI-игру — старт здесь. Быстро осваивайте современные инструменты.",
      "footer-email": "support@aiinfluencer.site",
    ...
    tr: {
      ...
      "hero-subtitle": "SADIK BİR INSTAGRAM KİTLESİ BÜYÜT<br><br>Yapay zekâyı birkaç günde öğren — <span class=\"text-purple-300 font-semibold\">SİHİR</span>i bugün başlat!",
      ...
      "pain-desc": "Başkalarının modellerine bak — AI senin elindeyken neler yaratacağını hayal et!",
      ...
      "benefits-desc": "Sosyal medya içeriğin için güçlü bir görsel kimlik kur; dijital varlığını büyüt.",
      "benefits-card-1-title": "Kendini sanatçı gibi hisset",
      "benefits-card-1-desc-1": "Mimar, tasarımcı, heykeltıraş, sanat yönetmeni, yapımcı, sahip — hepsine dönüş; hepsinin arkasındaki influencer süper kahramanı ol.",
      ...
      "benefits-card-2-desc-1-mobile": "Stüdyo olmadan çek. Moda düzeyi gerçekçilik; kusursuz cilt, ışık ve ton. Reklam, mağaza, sosyal için ideal.",
      ...
      "testimonial-subtitle": "Neden AI model üreticilerimiz kursu arkadaşlarıyla paylaşmaya devam ediyor?",
      "review-text-1": "❝ AI sonunda basit ve erişilebilir. Hazır araçları kullanmak çok keyifli—iyi ki denemişim! ❞",
      "review-name-1": "28, Mark R.",
      "review-role-1": "Startup kurucusu",
      "review-text-2": "❝ Eşimle sıfır bütçeyle yeni bir seri için 'yüz'e ihtiyacımız vardı. Kusursuz ama doğal cilde sahip bir AI model eğittik. Takipçiler onun gerçek bir top model olduğuna inanıyor—ilk haftada fondöten satışları %17 arttı. ❞",
      "review-name-2": "33, David K.",
      "review-role-2": "Marka Yöneticisi",
      "review-text-3": "❝ Görünüşümden endişe ederdim. Şimdi kendimin geliştirilmiş AI versiyonu var—editoryal kalite kareler, büyüyen kitle, reklamsız. Ben kameranın dışında kalıyorum, şık persona beğenileri topluyor. ❞",
      "review-name-3": "26, Tony Jr.",
      "review-role-3": "Seyahat Bloggerı",
      "review-text-4": "❝ Hiçbir şey işe yaramaz sanıyordum ama sıfırdan kurduğum bir influencer için IG sayfası yürütüyorum. Takipçiler bunun AI olduğuna inanamıyor. ❞",
      "review-name-4": "21, Huata A.",
      "review-role-4": "Öğrenci",
      "review-text-5": "❝ Teşekkürler, Leo! Açıklamaların tertemiz. Kursun ortasında ilk AI projemi başlattım—şimdiden sonuç veriyor. En sevdiğim eğitmenlerdensin. ❞",
      "review-name-5": "29, Elif S.",
      "review-role-5": "Motion Designer",
      "review-text-6": "❝ Mağaza için IG akışı istiyordum ama fotoğraf kalitesinden korkuyordum. AI gerçek gibi duran bir portre maskotu yaptı—müşteriler aynadan çok onunla selfie çekiyor! ❞",
      "review-name-6": "31, Murat K.",
      "review-role-6": "Berber Dükkanı Sahibi",
      "review-text-7": "❝ En yaşlı öğrenci ben olurum sanmıştım, ama kurs her şeyi lokma lokma ayırıyor. Üçüncü derste, ultra detaylı ciltle stüdyo seviyesinde bir karem vardı. Harika deneyim, Leo! ❞",
      "review-name-7": "50, Pav Williams L.",
      "review-role-7": "Girişimci",
      "review-text-8": "❝ Kursu şüpheyle denedim; gerçek ışığı AI'ın yerine koyamayacağına emindim. Yerine koymadı—yardım etti. Şimdi cilt-gerçekçi referanslar üretiyorum; çiftlere gösteriyorum ve vizyonu anında kavrıyorlar. Çekimler hızlı, kareler daha duygusal. ❞",
      ...
      "about-desc-p1": "Eski Dubai Future Labs AI araştırmacısı, şimdi içerik stratejisti. Eşiyle birlikte AI Influencer 3.0'ı kurdu—2.130+ yaratıcının AI destekli marka başlatmasına ve stüdyo bütçesi olmadan erişimini üçe katlamasına yardım etti.",
      "about-desc-p2": "Leo, ham fikirleri gelire çevirir: Midjourney, Omnisphere ve özel face-lock iş akışları maliyeti düşürür ve pazara çıkışı 3× hızlandırır.",
      ...
      "faq-desc": "Parasosyal bağlar kur — hayranların gerçekten bağlı hissetsin.",
      "faq-q1": "Max sordu… Sonuçları görmek ne kadar sürer?",
      "faq-a1": "İlk akşamda fotogerçek kareler; günde 1–2 saatle 4–7 günde tam bir akış.",
      "faq-q2": "Isabelle sordu… Bunu iş/okulla birlikte yapabilir miyim?",
      "faq-a2": "Evet. Dersler 20 dakikanın altında ve 7/24 talep üzerine — akşamları veya hafta sonu izle.",
      "faq-q3": "Anika sordu… Bu işe ne kadar zaman ayırmalıyım?",
      "faq-a3": "Günde 1–2 saat içerik başlatmak ve projeyi büyütmek için yeterli.",
      "faq-q4": "Hassan sordu… Hangi araçları satın almalıyım?",
      "faq-a4": "Sadece Midjourney — başlangıç için Basic $10/ay veya hız için Standard $30/ay. Diğer servisler ucuz, kullandığın kadar öde — tek bir profesyonel çekime kıyasla kuruşlar.",
      "faq-q5": "Sara sordu… Tutarlılığı nasıl koruyorsunuz?",
      "faq-a5": "Kursta Face-Lock Tutarlılık Sistemi var — her kare aynı çekimden gibi hissettiren, yüz özelliklerini kilitleyen hazır promptlar ve ayarlar.",
      "faq-q6": "Sophie sordu… Modelimin AI olduğu anlaşılır mı; yüzümü göstermeli miyim?",
      "faq-a6": "İş akışımız görüntüleri gerçek fotoğraf gibi yapar. Yüzünü göstermek zorunda değilsin — kurgusal persona ya da geliştirilmiş 'sen' kullan.",
      "faq-q7": "Alex sordu… Karakterimi özel/kişisel projelerde kullanabilir miyim?",
      "faq-a7": "Kesinlikle. Eğitilmiş model senindir — bloglarda, reklamlarda veya kapalı içerikte sınırsız kullan.",
      "faq-q8": "Bella sordu… Bu kursu farklı kılan ne; kendi hızımda öğrenebilir miyim?",
      "faq-a8": "2,5 saat damıtılmış adım adım video, hazır şablonlar, kontrol listeleri ve destek. Kendi hızında öğren; ömür boyu erişim ve güncellemeler.",

      // Final CTA
      "final-cta-title": "AI Modelleri 2030\'a kadar <span class=\"gradient-text-inverse\">$2.5B</span>\'lık bir sektör olacak",
      "final-cta-subtitle": "AI-influencer çılgınlığı, 2012 Bitcoin altına hücumu ve 2021 NFT patlaması gibi hissettiriyor.",
      "final-cta-save": "Bugün $98 tasarruf et!",
      "final-cta-btn-text": "Kursu Kap",
      "course-sales-label": "bugünkü kurs satışları",
      "footer-title": "AI Influencer 3.0",
      "footer-desc": "AI oyununa dal — rehberin burada başlıyor. Modern araçları hızla ustalaş.",
      "footer-email": "support@aiinfluencer.site",
      "footer-copyright": "© 2025 AI Influencer 3.0. Tüm hakları saklıdır.",
      "footer-legal": "Bu kurs yalnızca eğitim amaçlıdır. Sonuçlar garanti edilmez ve bireysel çaba, deneyim ve pazar koşullarına göre değişebilir. Bu kursu satın alarak ve kullanarak, hizmet şartlarımızı ve gizlilik politikamızı okuduğunuzu ve kabul ettiğinizi onaylarsınız. Kararlarınız, eylemleriniz ve kurs materyallerinin uygulanmasından kaynaklanan sonuçlar için tam sorumluluk üstlenirsiniz. Dijital ürünler, anında erişilebilir ve indirilebilir doğaları nedeniyle iade edilemez. Tüm içerik telif hakkı ve fikri mülkiyet yasalarıyla korunmaktadır.",
    }
  },

  // Применить переводы для указанного языка  
  apply(langCode) {
    if (!this.translations[langCode]) {
      console.warn(`Language "${langCode}" not found, using English`);
      langCode = 'en';
    }
    ...
    Object.keys(this.translations[lang]).forEach((key) => {
      ...
      if (element && this.translations[lang][key]) {
        // Используем textContent для градиентных элементов, чтобы сохранить CSS классы
    ...
    this.updateAboutTitle(lang);
  },

  // Сменить язык с применением переводов
  setLang(langCode) {
    this.apply(langCode);
  },
  ...
  // Специальная обработка заголовка секции About
  updateAboutTitle(lang) {
    ...
    if (aboutTitle) {
      ...
      if (titleText && titleGradient) {
        titleText.textContent = this.translations[lang]["about-title-text"];
        titleGradient.textContent = this.translations[lang]["about-title-gradient"];
      }
    }
  }
};