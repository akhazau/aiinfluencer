  ...
  constructor() {
    ...
    this.translations = {
      en: {
        ...
        // Benefits Section
        "benefits-title": "AI Model Making — Your",
        ...
        // Final CTA Section
        "final-cta-title": "AI Models Will Be a <span class=\"gradient-text\">$45,9B Industry</span> by 2030",
      ...
      ru: {
        ...
        "hero-subtitle": "ВЗРОСТИТЕ ВЕРНУЮ IG-АУДИТОРИЮ<br>Разберётся даже твой батя",
        "main-btn-text": "Получить предложение",
        "main-btn-price-old": "$120",
        "main-btn-price-new": "$27",
        ...
        "pain-card1-point2": "Безопасные настройки — никакого \"пластикового ИИ\"",
        ...
        "pain-card2-point3": "Пошаговые инструкции к первому кадру",
        ...
        // Benefits Section
        "benefits-title": "Создание AI-моделей — Ваша",
        ...
        "benefits-card-1-desc-1": "ВЫ СТАНЕТЕ дизайнером, арт-директором, продюсером — единственным супергероем-создателем всего, даже если вы новичок",
        "benefits-card-1-why-title": "Почему этот курс?",
        "benefits-card-1-feature-1": "Копировать → вставить → настроить → опубликовать",
        ...
        "benefits-card-1-feature-6": "Подходит для новичков",
        "benefits-card-1-feature-7": "Первая победа сегодня вечером",
