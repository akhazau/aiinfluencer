document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    en: {
      ...
      "review-name-3": "Tony Jr.",
      "review-role-3": "Travel Blogger",
      "review-text-4": "❝ I feared nothing would work, but now I run an Instagram page for an influencer I built from scratch. Followers can't believe it's AI. In class I launched Face-Lock and produced a full shoot in 30 minutes—my professor asked which studio I booked! ❞",
      "review-name-4": "Huata A.",
      ...
      "review-name-5": "Elif S.",
      "review-role-5": "Motion Designer",
      "review-text-6": "❝ I always wanted an Instagram feed for the shop but worried about photo quality. Turns out AI can create a portrait mascot almost indistinguishable from a real person. One evening of work, and now the character greets clients on our screens—people snap selfies with him more than with the mirror! ❞",
      "review-name-6": "Murat K.",
      "review-role-6": "Barbershop Owner",
      "review-text-7": "❝ I thought I'd be the oldest student, but the course breaks everything into bite-size steps. By lesson three I had a studio-grade shot with ultra-detailed skin—no camera or lighting gear. Clear pace, engaging content—fantastic experience, Leo! ❞",
      "review-name-7": "Pav Williams L.",
      "review-role-7": "Entrepreneur",
      "review-text-8": "❝ I tested the course skeptically, sure AI couldn't replace real lighting. It didn't—it helped. Now I generate skin-realistic references, show couples, and they get the vision instantly. Shoots run faster, images feel more emotional, not like generic AI art. ❞",
      "review-name-8": "Denis T.",
    ...
    ru: {
      ...
      "review-name-1": "Марк Р.",
      "review-role-1": "AI Креатор и SMM Стартапа",
      ...
      "review-name-2": "Давид К.",
      "review-role-2": "Бренд-менеджер, Косметические продукты",
      ...
      "review-name-4": "Хуата А.",
      "review-role-4": "Студент медиа-исследований",
      ...
      "review-name-6": "Мурат К.",
      "review-role-6": "Владелец парикмахерской",
