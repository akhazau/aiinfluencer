document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    en: {
      ...
      "hero-subtitle":
        'BUILD A LOYAL FANBASE ON INSTAGRAM<br>Master AI in days — unleash <span class="text-purple-300 font-bold md:font-bold">MAGIC</span> today!',
      ...
      // Final CTA Section
      "final-cta-title":
        'AI Models Will Be a<span class="gradient-text"> $1.5B Industry</span> by 2030',
      "final-cta-subtitle":
