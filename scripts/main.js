document.addEventListener("DOMContentLoaded", function () {
  ...
  const translations = {
    en: {
      ...
      "faq-q5": "<em>Sara asked…</em> How do you keep every shot consistent?",
      ...
      "faq-q6": "<em>Sophie asked…</em> Will people know my model is AI, and do I have to show my face?",
      ...
      "faq-q7": "<em>Alex asked…</em> Can I use my character for private or personal projects?",
      "faq-a7": "Absolutely. Your trained model is yours — use it in blogs, ads or closed content with no restrictions.",
      "faq-q8": "<em>Bella asked…</em> What makes this course different, and can I learn at my own pace?",
